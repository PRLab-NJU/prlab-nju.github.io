...
export default {
    ...
    computed: {
        ...
        selectedMember() {
            if (!this.selectedMemberUrl) {
                return null;
            }

            return this.localizedPeople.find(person => person.url === this.selectedMemberUrl) || null;
        }
    },
    methods: {
        ...
        goToPersonPage(member) {
            ...
            this.selectedMemberUrl = member.url;
