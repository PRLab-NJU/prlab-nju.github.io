...
.home-container {
    ...
    background-image: url('/images/bg9_cutted.jpg');
...
.description-section {
    width: 100vw;
    background: radial-gradient(ellipse at center, rgba(45, 45, 45, 1) 0%, rgba(25, 25, 25, 1) 50%, rgba(25, 25, 25, 1) 100%);
